...
public class HintsQueue {
	...
	public HintsQueue(Context context) {
		...
		mHintDialog = new AlertDialog.Builder(context)
				.setIcon(com.wartechwick.sudoku.R.drawable.ic_info)
				.setTitle(com.wartechwick.sudoku.R.string.hint)
				.setMessage("")
				.setPositiveButton(com.wartechwick.sudoku.R.string.close, mHintClosed).create();
