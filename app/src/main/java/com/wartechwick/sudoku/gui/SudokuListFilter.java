...
import com.wartechwick.sudoku.utils.StringUtils;
...
public class SudokuListFilter {
	...
	public String toString() {
		...
		if (showStateNotStarted) {
			visibleStates.add(mContext.getString(com.wartechwick.sudoku.R.string.not_started));
		}
		if (showStatePlaying) {
			visibleStates.add(mContext.getString(com.wartechwick.sudoku.R.string.playing));
		}
		if (showStateCompleted) {
			visibleStates.add(mContext.getString(com.wartechwick.sudoku.R.string.solved));
		}
