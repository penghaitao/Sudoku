...
import com.wartechwick.sudoku.gui.importing.AbstractImportTask;
import com.wartechwick.sudoku.gui.importing.SdmImportTask;
import com.wartechwick.sudoku.gui.importing.ExtrasImportTask;
import com.wartechwick.sudoku.gui.importing.OpenSudokuImportTask;
import com.wartechwick.sudoku.utils.Const;
...
public class SudokuImportActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.wartechwick.sudoku.R.layout.import_sudoku);
		getWindow().setFeatureDrawableResource(Window.FEATURE_LEFT_ICON,
				com.wartechwick.sudoku.R.mipmap.ic_launcher);

		ProgressBar progressBar = (ProgressBar) findViewById(com.wartechwick.sudoku.R.id.progress);
	...
	private AbstractImportTask.OnImportFinishedListener mOnImportFinishedListener = new AbstractImportTask.OnImportFinishedListener() {
