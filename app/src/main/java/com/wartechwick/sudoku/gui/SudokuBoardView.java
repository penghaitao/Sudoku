...
public class SudokuBoardView extends View {
	...
	public SudokuBoardView(Context context, AttributeSet attrs/*, int defStyle*/) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs, com.wartechwick.sudoku.R.styleable.SudokuBoardView/*, defStyle, 0*/);

		setLineColor(a.getColor(com.wartechwick.sudoku.R.styleable.SudokuBoardView_lineColor, Color.BLACK));
		setSectorLineColor(a.getColor(com.wartechwick.sudoku.R.styleable.SudokuBoardView_sectorLineColor, Color.BLACK));
		setTextColor(a.getColor(com.wartechwick.sudoku.R.styleable.SudokuBoardView_textColor, Color.BLACK));
		setTextColorReadOnly(a.getColor(com.wartechwick.sudoku.R.styleable.SudokuBoardView_textColorReadOnly, Color.BLACK));
		setTextColorNote(a.getColor(com.wartechwick.sudoku.R.styleable.SudokuBoardView_textColorNote, Color.BLACK));
		setBackgroundColor(a.getColor(com.wartechwick.sudoku.R.styleable.SudokuBoardView_backgroundColor, Color.WHITE));
		setBackgroundColorSecondary(a.getColor(com.wartechwick.sudoku.R.styleable.SudokuBoardView_backgroundColorSecondary, NO_COLOR));
		setBackgroundColorReadOnly(a.getColor(com.wartechwick.sudoku.R.styleable.SudokuBoardView_backgroundColorReadOnly, NO_COLOR));
		setBackgroundColorTouched(a.getColor(com.wartechwick.sudoku.R.styleable.SudokuBoardView_backgroundColorTouched, Color.rgb(50, 50, 255)));
		setBackgroundColorSelected(a.getColor(com.wartechwick.sudoku.R.styleable.SudokuBoardView_backgroundColorSelected, Color.YELLOW));
	...
	public void setCells(CellCollection cells) {
		...
		if (mCells != null) {
			if (!mReadonly) {
				mSelectedCell = mCells.getCell(0, 0); // first cell will be selected by default--But I don't want the first cell to be selected by default
...
//							isInvalid = true;
//							Log.i("pp","333"+mHighlightWrongVals+cell.getColumnIndex()+cell.getRowIndex());
...
//			}
			...
			// imprecision)
			if (mHighlightTouchedCell && (mSelectedCell != null || mTouchedCell != null)) {
				Cell mCell = mSelectedCell;
				if (mTouchedCell != null) {
					mCell = mTouchedCell;
				}
				cellLeft = Math.round(mCell.getColumnIndex() * mCellWidth) + paddingLeft;
				cellTop = Math.round(mCell.getRowIndex() * mCellHeight) + paddingTop;
				canvas.drawRect(
						cellLeft, paddingTop,
