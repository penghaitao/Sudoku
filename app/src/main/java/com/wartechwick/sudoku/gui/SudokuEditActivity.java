...
import com.wartechwick.sudoku.gui.inputmethod.InputMethod;
...
public class SudokuEditActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.wartechwick.sudoku.R.layout.sudoku_edit);
		mRootLayout = (ViewGroup) findViewById(com.wartechwick.sudoku.R.id.root_layout);
		mBoard = (SudokuBoardView) findViewById(com.wartechwick.sudoku.R.id.sudoku_board);
		...
		mInputMethods = (IMControlPanel) findViewById(com.wartechwick.sudoku.R.id.input_methods);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(0, MENU_ITEM_SAVE, 0, com.wartechwick.sudoku.R.string.save)
				.setShortcut('1', 's')
				.setIcon(com.wartechwick.sudoku.R.drawable.ic_save);
		menu.add(0, MENU_ITEM_CANCEL, 1, android.R.string.cancel)
				.setShortcut('3', 'c')
				.setIcon(com.wartechwick.sudoku.R.drawable.ic_close);
	...
	private void savePuzzle() {
		...
		switch (mState) {
			case STATE_EDIT:
				...
				Toast.makeText(getApplicationContext(), com.wartechwick.sudoku.R.string.puzzle_updated, Toast.LENGTH_SHORT).show();
				break;
			case STATE_INSERT:
				mGame.setCreated(System.currentTimeMillis());
				mDatabase.insertSudoku(mFolderID, mGame);
				Toast.makeText(getApplicationContext(), com.wartechwick.sudoku.R.string.puzzle_inserted, Toast.LENGTH_SHORT).show();
				break;
		}
	}
}
