...
public class FileListActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(com.wartechwick.sudoku.R.layout.file_list);
		...
		int[] to = {com.wartechwick.sudoku.R.id.name, com.wartechwick.sudoku.R.id.detail};

		SimpleAdapter adapter = new SimpleAdapter(this, (List<? extends Map<String, ?>>) mList, com.wartechwick.sudoku.R.layout.folder_list_item, from, to);
	...
	protected void onPrepareDialog(int id, Dialog dialog) {
		...
		switch (id) {
			case DIALOG_IMPORT_FILE:
				dialog.setTitle(getString(com.wartechwick.sudoku.R.string.import_file_title, mSelectedFile.getName()));
				break;
		}
	}
	...
	private static class FileListViewBinder implements ViewBinder {
		...
		public boolean setViewValue(View view, Object data,
			...
			switch (view.getId()) {
				case com.wartechwick.sudoku.R.id.detail:
					if (data == null) {
