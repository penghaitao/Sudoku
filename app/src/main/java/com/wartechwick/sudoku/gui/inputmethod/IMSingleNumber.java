...
import com.wartechwick.sudoku.game.Cell;
import com.wartechwick.sudoku.game.CellNote;
import com.wartechwick.sudoku.game.SudokuGame;
import com.wartechwick.sudoku.gui.HintsQueue;
import com.wartechwick.sudoku.gui.SudokuBoardView;
import com.wartechwick.sudoku.gui.inputmethod.IMControlPanelStatePersister.StateBundle;
...
public class IMSingleNumber extends InputMethod {
	...
	public int getNameResID() {
		return com.wartechwick.sudoku.R.string.single_number;
	}

	@Override
	public int getHelpResID() {
		return com.wartechwick.sudoku.R.string.im_single_number_hint;
	}

	@Override
	public String getAbbrName() {
		return mContext.getString(com.wartechwick.sudoku.R.string.single_number_abbr);
	}

	@Override
	protected View createControlPanelView() {
		LayoutInflater inflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		View controlPanel = inflater.inflate(com.wartechwick.sudoku.R.layout.im_single_number, null);

		mNumberButtons = new HashMap<Integer, Button>();
		mNumberButtons.put(1, (Button) controlPanel.findViewById(com.wartechwick.sudoku.R.id.button_1));
		mNumberButtons.put(2, (Button) controlPanel.findViewById(com.wartechwick.sudoku.R.id.button_2));
		mNumberButtons.put(3, (Button) controlPanel.findViewById(com.wartechwick.sudoku.R.id.button_3));
		mNumberButtons.put(4, (Button) controlPanel.findViewById(com.wartechwick.sudoku.R.id.button_4));
		mNumberButtons.put(5, (Button) controlPanel.findViewById(com.wartechwick.sudoku.R.id.button_5));
		mNumberButtons.put(6, (Button) controlPanel.findViewById(com.wartechwick.sudoku.R.id.button_6));
		mNumberButtons.put(7, (Button) controlPanel.findViewById(com.wartechwick.sudoku.R.id.button_7));
		mNumberButtons.put(8, (Button) controlPanel.findViewById(com.wartechwick.sudoku.R.id.button_8));
		mNumberButtons.put(9, (Button) controlPanel.findViewById(com.wartechwick.sudoku.R.id.button_9));
		mNumberButtons.put(0, (Button) controlPanel.findViewById(com.wartechwick.sudoku.R.id.button_clear));
		...
		mSwitchNumNoteButton = (ImageButton) controlPanel.findViewById(com.wartechwick.sudoku.R.id.switch_num_note);
	...
	private void update() {
		switch (mEditMode) {
			case MODE_EDIT_NOTE:
				mSwitchNumNoteButton.setImageResource(com.wartechwick.sudoku.R.drawable.ic_edit_white);
				break;
			case MODE_EDIT_VALUE:
				mSwitchNumNoteButton.setImageResource(com.wartechwick.sudoku.R.drawable.ic_edit_grey);
				break;
		}
