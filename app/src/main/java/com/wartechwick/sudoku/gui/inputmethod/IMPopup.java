...
import com.wartechwick.sudoku.gui.inputmethod.IMPopupDialog.OnNoteEditListener;
import com.wartechwick.sudoku.gui.inputmethod.IMPopupDialog.OnNumberEditListener;
...
public class IMPopup extends InputMethod {
	...
	public int getNameResID() {
		return com.wartechwick.sudoku.R.string.popup;
	}

	@Override
	public int getHelpResID() {
		return com.wartechwick.sudoku.R.string.im_popup_hint;
	}

	@Override
	public String getAbbrName() {
		return mContext.getString(com.wartechwick.sudoku.R.string.popup_abbr);
	}

	@Override
	protected View createControlPanelView() {
		LayoutInflater inflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		return inflater.inflate(com.wartechwick.sudoku.R.layout.im_popup, null);
	}
