package com.wartechwick.sudoku.gui.importing;
...
import com.wartechwick.sudoku.db.SudokuImportParams;
import com.wartechwick.sudoku.db.SudokuInvalidFormatException;
			...
			while (eventType != XmlPullParser.END_DOCUMENT) {
				if (eventType == XmlPullParser.START_TAG) {
					...
					if (rootTag.equals("sudoku")) {
						...
						setError(mContext.getString(com.wartechwick.sudoku.R.string.invalid_format));
						return;
					}
				}
				eventType = xpp.next();
