...
import com.wartechwick.sudoku.gui.SudokuBoardView.OnCellSelectedListener;
import com.wartechwick.sudoku.gui.SudokuBoardView.OnCellTappedListener;
...
public class IMControlPanel extends LinearLayout {
	...
	public static final int INPUT_METHOD_POPUP = 1;
	public static final int INPUT_METHOD_SINGLE_NUMBER = 2;
	...
	public void initialize(SudokuBoardView board, SudokuGame game, HintsQueue hintsQueue) {
		...
		mHintsQueue = null;// to make sure there is no hint- by p
		createInputMethods();
	}
	...
	private OnClickListener mSwitchModeListener = new OnClickListener() {
		...
		public void onClick(View v) {
			Toast.makeText(mContext, "happy playing...", Toast.LENGTH_SHORT).show();
