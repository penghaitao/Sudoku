...
public class FolderInfo {
	...
	public String getDetail(Context c) {
		...
		if (puzzleCount == 0) {
			...
			sb.append(c.getString(com.wartechwick.sudoku.R.string.no_puzzles));
		} else {
			// there are some puzzles
			sb.append(puzzleCount == 1 ? c.getString(com.wartechwick.sudoku.R.string.one_puzzle) : c.getString(com.wartechwick.sudoku.R.string.n_puzzles, puzzleCount));
			...
			if (playingCount != 0 || unsolvedCount != 0) {
				...
				if (playingCount != 0) {
					sb.append(c.getString(com.wartechwick.sudoku.R.string.n_playing, playingCount));
					if (unsolvedCount != 0) {
						sb.append(", ");
					}
				}
				...
				if (unsolvedCount != 0) {
					sb.append(c.getString(com.wartechwick.sudoku.R.string.n_unsolved, unsolvedCount));
				}
			...
			if (unsolvedCount == 0 && puzzleCount != 0) {
				sb.append(" (").append(c.getString(com.wartechwick.sudoku.R.string.all_solved)).append(")");
			}
