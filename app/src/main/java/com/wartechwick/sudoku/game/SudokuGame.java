...
package com.wartechwick.sudoku.game;

import android.os.Bundle;
import android.os.SystemClock;

import com.wartechwick.sudoku.game.command.AbstractCommand;
import com.wartechwick.sudoku.game.command.ClearAllNotesCommand;
import com.wartechwick.sudoku.game.command.CommandStack;
import com.wartechwick.sudoku.game.command.EditCellNoteCommand;
import com.wartechwick.sudoku.game.command.FillInNotesCommand;
import com.wartechwick.sudoku.game.command.SetCellValueCommand;
...
public class SudokuGame {
    ...
    public void setmSudokuName(String mSudokuName) {
        this.mSudokuName = mSudokuName;
    }

    public String getmSudokuName() {
        return mSudokuName;
    }
